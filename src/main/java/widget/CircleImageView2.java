...
public class CircleImageView2 extends ImageView{
    ...
    private static final int DEFAILT_BORDER_WIDTH = 0;
    private static final int DEFAULT_BORDER_COLOR = Color.BLACK;

    private int mBorderWidth = DEFAILT_BORDER_WIDTH;
...
//        super(context, attrs);
    ...
    public CircleImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView2_border_width,DEFAILT_BORDER_WIDTH);
